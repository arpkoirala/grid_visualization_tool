...
def map_style(radio_value_loading, radio_value_buscolor,n_clicks):
    ...
    if "commit" == ctx.triggered_id: # whent the commit button is pressed, the switches are opened and closed
...
app.run_server(debug=False) # Turn on debug for error messages on the webpage